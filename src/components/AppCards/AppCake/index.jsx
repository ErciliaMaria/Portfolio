...
function AppCake() {
    return (
        <div className="m-8">
            <img className="object-cover w-full rounded-t-lg h-96 md:h-60 md:w-48" src={SiteCake} alt="Site Cake" />
            <div className="flex flex-col justify-around p-4 leading-normal h-40">
                <h5 className=" text-2xl font-bold tracking-tight text-white text-center">Site Cake</h5>
