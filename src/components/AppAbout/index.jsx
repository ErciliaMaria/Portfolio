...
function AppAbout(){
    return(
        <div className="about h-166 flex flex-col md:flex-row items-center justify-center gap-8 p-6">
            <div className="flex-shrink-0">
                <img className="w-48 h-48 md:w-94 md:h-94 rounded-full object-cover mask-r-from-10%" src={FotoPerfil}/>
            </div>

            <div className="text-white max-w-xl text-base md:text-lg space-y-6 container mx-auto">
                <p className="text-[#fff] text-xl h-auto max-w-lg  rounded-full" >Hi, my name is 
                    <span className="underline hover:text-purple-600 text-2xl"> Ercilia Carvalho.</span></p>
                <p className="text-[#fff] text-xl h-auto max-w-lg  rounded-full my-8" >
                    I am currently studying Analysis and Systems Development, focusing on improving my skills 
                    in both Frontend and Backend.</p>
            
                 <p className="text-[#fff] text-xl h-auto max-w-lg  rounded-full" >
                ...
                <p className="text-[#fff] text-ml h-auto max-w-lg" >
                    Ready?</p>
            </div>
        </div>
    )
